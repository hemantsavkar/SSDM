...
/************************************************************************
    Filtered Fancybox image gallery 
...
<title>Gallery::Shri Sai Das Mandal Shivajinagar, Pune</title>
<!-- general styles: use your own -->
<link rel="stylesheet" type="text/css" href="/Gallery_files/demos.css" />
<!-- Set your paths accordingly -->
<link rel="stylesheet" type="text/css" href="/Gallery_files/jquery.fancybox.css" />
<link rel="stylesheet" type="text/css" href="/Gallery_files/jquery.fancybox-buttons.css" />
<style type="text/css">
...
<script src="./Gallery_files/jquery-1.8.3.min.js"></script>
<script>window.jQuery || document.write("<script src='http://picssel.com/scripts/jquery-1.8.3.min.js'>\x3C/script>")</script>
<script src="Gallery_files/jquery.fancybox.pack.js"></script>
<script src="Gallery_files/jquery.fancybox-buttons.js"></script>
<script>
jQuery(function($){
  // The Fancybox script
  $(".fancybox").fancybox({
